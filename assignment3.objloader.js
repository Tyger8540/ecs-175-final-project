...
class OBJLoader {
    ...
    load( gl ) {
        ...
        if (material.hasTexture()) {
            ...
            // console.log("pos: " + vertex_positions.length)
            // console.log("norm: " + vertex_normals.length)
            // console.log("tan: " + vertex_tangents.length)
            // console.log("tex: " + vertex_texture_coords.length)
            
            // TODO: Pass tangents and texture coordinates
            // vertex_data.push(vertex_tangents)
            // vertex_data.push(vertex_texture_coords)

            // adds position, normal, tangent, and texture coordinate to the vertex_data
            let j = 0
