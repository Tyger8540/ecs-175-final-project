...
class ShadedObject3D extends Object3D { 
    ...
    render( gl )
    {
        ...
        // this.shader.setUniform1i('u_material.map_kD', 0); // map to texture unit 0
        // this.shader.setUniform1i('u_material.map_nS', 1); // map to texture unit 1
        // this.shader.setUniform1i('u_material.map_norm', 2); // map to texture unit 2
        ...
        if (this.material.hasMapKD()) {
            ...
            gl.bindTexture(gl.TEXTURE_2D, this.material.getMapKD())  // bind texture unit
            this.shader.setUniform1i('u_material.map_kD', 0)  // set uniform for texture unit
        }

        if (this.material.hasMapNS()) {
            // TODO
            gl.activeTexture(gl.TEXTURE1)  // activate texture unit
            gl.bindTexture(gl.TEXTURE_2D, this.material.getMapNS())  // bind texture unit
            this.shader.setUniform1i('u_material.map_nS', 1)  // set uniform for texture unit
        }

        if (this.material.hasMapNorm()) {
            // TODO
            gl.activeTexture(gl.TEXTURE2)  // activate texture unit
            gl.bindTexture(gl.TEXTURE_2D, this.material.getMapNorm())  // bind texture unit
            this.shader.setUniform1i('u_material.map_norm', 2)  // set uniform for texture unit
        }
